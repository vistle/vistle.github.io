...
This module is designed to read [TsunamiHySEA](https://edanya.uma.es/hysea/index.php/models/tsunami-hysea) files in NetCDF format.
*TsunamiHySEA* is a numerical model for quake generated tsunami simulations.
...
[](project:#mod-MapDrape), [](project:#mod-IndexManifolds)
