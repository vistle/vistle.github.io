...
# SelectCells
filter elements according to their index

<svg width="73.8em" height="10.6em" >
...
<text x="0.2em" y="5.65em" class="moduleName" >SelectCells</text><rect x="0.2em" y="5.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
...
<text x="1.9em" y="9.9em" class="text" >output data<tspan> (data_out)</tspan></text>
...
|-|-|-|
|reuse_coordinates|do not renumber vertices and reuse coordinate and data arrays (if possible)|Int|
|invert_selection|invert cell selection|Int|
|selection|values to select|String|
