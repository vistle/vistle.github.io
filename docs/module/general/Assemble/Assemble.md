...
<text x="1.9em" y="0.8999999999999998em" class="text" >geometry with mapped data<tspan> (data_in0)</tspan></text>
...
<text x="3.0999999999999996em" y="1.9em" class="text" >geometry with mapped data<tspan> (data_in1)</tspan></text>
...
<text x="4.3em" y="2.9em" class="text" >geometry with mapped data<tspan> (data_in2)</tspan></text>
<text x="0.2em" y="5.65em" class="moduleName" >Assemble</text><rect x="0.2em" y="5.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
...
<text x="1.9em" y="9.9em" class="text" >geometry assembled into single block per rank<tspan> (data_out0)</tspan></text>
...
<text x="3.0999999999999996em" y="8.9em" class="text" >geometry assembled into single block per rank<tspan> (data_out1)</tspan></text>
...
<text x="4.3em" y="7.8999999999999995em" class="text" >geometry assembled into single block per rank<tspan> (data_out2)</tspan></text>
</svg>
