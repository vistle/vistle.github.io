...
<text x="1.9em" y="0.9em" class="text" >geometry, e.g. points or lines (also with radius), polygons<tspan> (grid_in)</tspan></text>
<text x="0.2em" y="3.6500000000000004em" class="moduleName" >ToTriangles</text><rect x="0.2em" y="3.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
