...
<text x="1.9em" y="0.9em" class="text" >bare input grid without mapped data<tspan> (data_in)</tspan></text>
...
<text x="1.9em" y="5.8999999999999995em" class="text" >clipped grid<tspan> (data_out)</tspan></text>
</svg>
