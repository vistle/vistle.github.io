...
# SelectVertices
filter vertices according to their index
...
<text x="1.9em" y="0.8999999999999998em" class="text" >input <tspan> (data_in)</tspan></text>
...
<text x="0.2em" y="5.65em" class="moduleName" >SelectVertices</text><rect x="0.2em" y="5.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
...
|-|-|-|
|invert_selection|invert vertex selection|Int|
|selection|vertices to select|String|
|block_selection|blocks to select|String|
