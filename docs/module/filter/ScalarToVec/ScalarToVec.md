...
<rect x="0em" y="3.8em" width="7.38em" height="3.0em" rx="0.1em" ry="0.1em" style="fill:#64c8c8ff;" />
...
<text x="1.9em" y="0.8999999999999998em" class="text" >scalar input to be combined<tspan> (data_in0)</tspan></text>
...
<text x="3.0999999999999996em" y="1.9em" class="text" >scalar input to be combined<tspan> (data_in1)</tspan></text>
...
<text x="4.3em" y="2.9em" class="text" >scalar input to be combined<tspan> (data_in2)</tspan></text>
<text x="0.2em" y="5.65em" class="moduleName" >ScalarToVec</text><rect x="0.2em" y="5.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
...
|-|-|-|
|species|Species for output|String|
|fill_mode|How to fill missing components (Zero, One)|Int|
