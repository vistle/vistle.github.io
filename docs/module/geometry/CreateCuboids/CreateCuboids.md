...
# CreateCuboids
creates cuboids out of a grid with (3D vector) mapped data where the grid's coordinates are the cuboid centers and its mapped data the edge lengths in x, y, z
...
<text x="1.9em" y="0.9em" class="text" >grid containing cuboid definitions<tspan> (grid_in)</tspan></text>
<text x="0.2em" y="3.6500000000000004em" class="moduleName" >CreateCuboids</text><rect x="0.2em" y="3.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
...
<text x="1.9em" y="5.8999999999999995em" class="text" >grid containing cuboids<tspan> (grid_out)</tspan></text>
</svg>
