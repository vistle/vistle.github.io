...
start Vistle and the [InSituModule](../../../../../module/simulation/InSituModule/InSituModule.md) module. The module should automatically connect and create output ports for the data fields the simulation provides.
