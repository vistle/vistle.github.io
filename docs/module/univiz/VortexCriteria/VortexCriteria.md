...
<text x="0.2em" y="3.6500000000000004em" class="moduleName" >VortexCriteria</text><rect x="0.2em" y="3.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c81e1eff;" >
<title>scalar</title></rect>
...
<text x="1.9em" y="5.8999999999999995em" class="text" >Scalar Criterion<tspan> (scalar)</tspan></text>
</svg>

## Parameters
|name|description|type|
|-|-|-|
|quantity|quantity (Helicity, Velo_norm_helicity, Vorticity_magnitude, Z_vorticity, Lambda2, Q, Delta, Div_accel, Divergence)|Int|
|smoothingRange|smoothing range for gradient|Int|
