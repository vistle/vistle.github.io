...
<text x="1.9em" y="0.8999999999999998em" class="text" >mapped vertex data field (or grid)<tspan> (data_in)</tspan></text>
...
<text x="3.0999999999999996em" y="1.9em" class="text" >mapped vertex data field (or grid)<tspan> (data_in1)</tspan></text>
...
<text x="4.3em" y="2.9em" class="text" >mapped vertex data field (or grid)<tspan> (data_in2)</tspan></text>
<text x="0.2em" y="5.65em" class="moduleName" >WritePointsCsv</text></svg>
...
|write_header|write header line|Int|
|write_coordinates|write coordinates of associated point|Int|
|write_data|write mapped data|Int|
|write_time|write timestep number|Int|
|write_block|write block number|Int|
|write_index|write vertex index|Int|
